# This program calculates the average end-to-end packet delays for each time2interval in traffic flow 0

# Usage: awk -f 6example2avgdelay_flow0.awk example2.tr
...
if ( flow_id == 0) {
	...
	if (timeInterval >= 0.5) {
		...
		printf("%f \t %f\n", time2, delay) > "example2avgdelay_flow0.xls";
